...
\def\N{{\msbmten N}}   % přirozená čísla
\def\Z{{\msbmten Z}}   % celá čísla
\def\Q{{\msbmten Q}}   % racionální čísla
\def\I{{\msbmten I}}   % iracionální čísla
\def\R{{\msbmten R}}   % reálná čísla
\def\C{{\msbmten C}}   % komplexní čísla
\def\H{{\msbmten H}}   % kvaterniony
\def\F{{\msbmten F}}   % těleso (field), obecně
\def\P{{\msbmten P}}   % množina prvočísel nebo projektivní prostor
